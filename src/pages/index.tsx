  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Foox again - Your ultimate marketplace where freelancers meet companies offering exciting job opportunities. Explore, Connect, and Grow together!"
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Foox again - Your ultimate marketplace where freelancers meet companies offering exciting job opportunities. Explore, Connect, and Grow together!`}
            </Text>
            <Box
